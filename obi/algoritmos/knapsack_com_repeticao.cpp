...
int knapsack(int obj, int aguenta){
	...
	int coloca = max(
		valor[obj] + knapsack(obj + 1, aguenta - peso[obj]), valor[obj] + knapsack(obj, aguenta - peso[obj])
	); // Melhor caso entre colocar o objeto e repetir ele ou colocar o objeto e partir para o próximo
