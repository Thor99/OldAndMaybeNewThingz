...
void Camera::DesenhaMira()
{
	glLineWidth(1.5);
	glColor3f(0.0, 0.0, 0.0);
	glBegin(GL_LINES);
	glVertex3f(m_center.x, m_center.y - 0.1, m_center.z + 0.3);
	glVertex3f(m_center.x, m_center.y - 0.1, m_center.z - 0.3);
	glVertex3f(m_center.x - 0.3, m_center.y - 0.1, m_center.z);
	glVertex3f(m_center.x + 0.3, m_center.y - 0.1, m_center.z);
	glVertex3f(m_center.x , m_center.y - 0.4, m_center.z);
	glVertex3f(m_center.x , m_center.y + 0.2, m_center.z);
	glEnd();
}
