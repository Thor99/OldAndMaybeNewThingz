...
void display()
{
    ...
    float cordif[4] = {0.5, 0, 0.5, 1};
    glMaterialfv(GL_FRONT_AND_BACK, GL_DIFFUSE, cordif);

    float corspec[4] = {0.5, 0.5, 0.5, 1};
    glMaterialfv(GL_FRONT_AND_BACK, GL_SPECULAR, cordif);

    float shi = 1;
    glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, shi);

    glutSolidTeapot(2); // Desenha um bule de chá, de tamanho 2
    glutSolidSphere(1, 50, 50); // Esfera de raio 1, com 50 de slices verticais e horizontais
