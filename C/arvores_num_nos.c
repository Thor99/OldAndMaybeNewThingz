...
int igual(Arv* a1, Arv* a2){
	...
	return a1->valor == a2->valor && igual(a1->esq, a2->esq) && igual(a1->dir, a2->dir);
}
...
int num_nos(Arv* a1){
	...
	numero_nos = 1 + num_nos(a1->esq) + num_nos(a1 -> dir); // raiz + todos os nós da esquerda + todos o nós da direita
	return numero_nos;
}
